...
Shader "FX/Water_AlphaCutoff (simple)" {
Properties {
	...
	_DissolveTex ("Dissovle (GREYSCALE)", 2D) = "white" {}
...
half4 frag( v2f i ) : COLOR
{
	...
	float4 a = tex2D(_DissolveTex, i.texcoord);
	col.a = DecodeFloatRGBA(a);//_horizonColor.a;
	return col;
}
ENDCG
	}
